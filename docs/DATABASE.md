...
- `Database.Migrate()`: UserAPI, ComicAPI, ChapterAPI, SocialAPI, MissionAPI, PaymentAPI, WalletAPI, and BannerAPI.

All services now use standard EF Core migrations at startup.
