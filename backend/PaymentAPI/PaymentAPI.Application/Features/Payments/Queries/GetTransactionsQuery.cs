...
{
    public class GetTransactionsQuery : IRequest<ApiResponse<PagedResult<PaymentAPI.DTOs.TransactionDto>>>
    {
    ...
    public class GetTransactionsQueryHandler : IRequestHandler<GetTransactionsQuery, ApiResponse<PagedResult<PaymentAPI.DTOs.TransactionDto>>>
    {
        ...
        public GetTransactionsQueryHandler(IPaymentRepository repository, ChapterGrpc.ChapterGrpcClient chapterGrpcClient, WalletService.WalletServiceClient walletGrpcClient, IRequestClient<SubmitPurchaseCommand> purchaseClient, IOptions<TopUpSettings> topUpOptions, IOptions<BankSettings> bankOptions)
        {
        ...
        public async Task<ApiResponse<PagedResult<PaymentAPI.DTOs.TransactionDto>>> Handle(GetTransactionsQuery request, CancellationToken cancellationToken)
        {
            ...
            var paginated = new PagedResult<PaymentAPI.DTOs.TransactionDto>(dtos, totalCount, request.PageNumber, request.PageSize);
