...
{
    public class GetOutstandingComicsListQuery : IRequest<ApiResponse<List<ComicSummaryDto>>>
    {
        public int Limit { get; set; }
    }

    public class GetOutstandingComicsListQueryHandler : IRequestHandler<GetOutstandingComicsListQuery, ApiResponse<List<ComicSummaryDto>>>
    {
        ...
        public GetOutstandingComicsListQueryHandler(IComicRepository comicRepository, IMapper mapper, UserService.UserServiceClient userServiceClient, IDistributedCache cache)
        {
        ...
        public async Task<ApiResponse<List<ComicSummaryDto>>> Handle(GetOutstandingComicsListQuery request, CancellationToken cancellationToken)
        {
