...
{
    public class GetLastCompletedComicsQuery : IRequest<ApiResponse<List<ComicSummaryDto>>>
    {
        public int Limit { get; set; }
    }

    public class GetLastCompletedComicsQueryHandler : IRequestHandler<GetLastCompletedComicsQuery, ApiResponse<List<ComicSummaryDto>>>
    {
        ...
        public GetLastCompletedComicsQueryHandler(IComicRepository comicRepository, IMapper mapper, UserService.UserServiceClient userServiceClient, IDistributedCache cache)
        {
        ...
        public async Task<ApiResponse<List<ComicSummaryDto>>> Handle(GetLastCompletedComicsQuery request, CancellationToken cancellationToken)
        {
